function all(){
    ...
    $.ajax({
        url: 'http://localhost:9000/v1/seguridad/Rol', // Reemplaza con la URL de tu API
        method: 'GET',
...
function findById(id){
    $.ajax({
        url: 'http://localhost:9000/v1/seguridad/Rol/'+id, // Reemplaza con la URL de tu API
        method: 'GET',
        success: function(data) {
            $("#id").val(data.id);
...
function update(){
    ...
    // Enviar datos al servidor mediante AJAX
    $.ajax({
        url: 'http://localhost:9000/v1/seguridad/Rol/'+$("#id").val(), // Reemplaza con la URL de tu API
...
function deleteLogical(id){
   // Crear un objeto JSON con los datos
    ...
    // Enviar datos al servidor mediante AJAX
    $.ajax({
        url: 'http://localhost:9000/v1/seguridad/Rol/deleteLogical/'+id, // Reemplaza con la URL de tu API
        method: 'PUT',  // Cambia a 'PUT' si es una actualización
        contentType: 'application/json',
        data: JSON.stringify(jsonData),
        success: function(response) {
